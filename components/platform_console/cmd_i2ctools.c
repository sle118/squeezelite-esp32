...
bool is_i2c_started(i2c_port_t port) {
    ...
    if(ret == ESP_OK) { ret = i2c_master_write_byte(cmd, WRITE_BIT, ACK_CHECK_EN); }
    if(ret == ESP_OK) { ret = i2c_master_stop(cmd); }
    if(ret == ESP_OK) { ret = i2c_master_cmd_begin(port, cmd, 50 / portTICK_PERIOD_MS); }
...
static const i2c_db_t i2c_db[] = {{.address = 0x00, .description = "Unknown"}, {.address = 0x01, .description = "Unknown"},
    {.address = 0x02, .description = "Unknown"}, {.address = 0x03, .description = "Unknown"}, {.address = 0x04, .description = "Unknown"},
    {.address = 0x05, .description = "Unknown"}, {.address = 0x06, .description = "Unknown"}, {.address = 0x07, .description = "Unknown"},
    {.address = 0x08, .description = "Unknown"}, {.address = 0x0c, .description = "AK8975"}, {.address = 0x0d, .description = "AK8975"},
    {.address = 0x0e, .description = "MAG3110 AK8975 IST-8310"}, {.address = 0x0f, .description = "AK8975"},
    ...
    {.address = 0x12, .description = "SEN-17374"}, {.address = 0x13, .description = "VCNL40x0 SEN-17374"},
    {.address = 0x18, .description = "MCP9808 LIS3DH LSM303 COM-15093"}, {.address = 0x19, .description = "MCP9808 LIS3DH LSM303 COM-15093"},
    {.address = 0x1a, .description = "AC101 MCP9808"}, {.address = 0x1b, .description = "MCP9808"},
    {.address = 0x1c, .description = "MCP9808 MMA845x FXOS8700"}, {.address = 0x1d, .description = "MCP9808 MMA845x ADXL345 FXOS8700"},
    {.address = 0x1e, .description = "HMC5883 LSM303 MCP9808 LSM303 FXOS8700"}, {.address = 0x1f, .description = "MCP9808 FXOS8700"},
    ...
    {.address = 0x25, .description = "TCA9554 MCP23008 PCD3312C MCP23017 PCD3311C"}, {.address = 0x26, .description = "MCP23008 MCP23017 TCA9554"},
    {.address = 0x27, .description = "MCP23008 MCP23017 HIH6130 TCA9554"}, {.address = 0x28, .description = "BNO055 CAP1188"},
    {.address = 0x29, .description = "BNO055 VL53L0x VL6180X CAP1188 TCS34725 TSL2591"}, {.address = 0x2a, .description = "CAP1188"},
    {.address = 0x2b, .description = "CAP1188"}, {.address = 0x2c, .description = "CAP1188 AD5248 AD5251 AD5252 CAT5171"},
    {.address = 0x2d, .description = "CAP1188 AD5248 AD5251 AD5252 CAT5171"}, {.address = 0x2e, .description = "AD5248 AD5251 AD5252 LPS22HB"},
    {.address = 0x2f, .description = "AD5248 AD5243 AD5251 AD5252"}, {.address = 0x30, .description = "SAA2502"},
    {.address = 0x31, .description = "SAA2502"}, {.address = 0x33, .description = "MLX90640"},
    {.address = 0x38, .description = "FT6x06 VEML6070 BMA150 SAA1064 SEN-15892 PCF8574AP"},
    {.address = 0x39, .description = "TSL2561 APDS-9960 VEML6070 SAA1064 PCF8574AP"}, {.address = 0x3a, .description = "PCF8577C SAA1064 PCF8574AP"},
    ...
    {.address = 0x3d, .description = "SSD1305 SSD1306 PCF8578 SH1106 PCF8574AP"}, {.address = 0x3e, .description = "PCF8574AP"},
    ...
    {.address = 0x4c, .description = "PCA9685 INA219 INA260 PCF8574"}, {.address = 0x4d, .description = "PCA9685 INA219 INA260 PCF8574"},
    {.address = 0x4e, .description = "PCA9685 INA219 INA260 PCF8574"}, {.address = 0x4f, .description = "PCA9685 INA219 INA260 PCF8574"},
    {.address = 0x50, .description = "PCA9685 MB85RC"}, {.address = 0x51, .description = "PCA9685 MB85RC VCNL4200"},
    {.address = 0x52, .description = "PCA9685 MB85RC Nunchuck controller APDS-9250 SI1133"},
    {.address = 0x53, .description = "ADXL345 PCA9685 MB85RC"}, {.address = 0x54, .description = "PCA9685 MB85RC"},
    {.address = 0x55, .description = "PCA9685 MB85RC MAX30101 SI1133"}, {.address = 0x56, .description = "PCA9685 MB85RC"},
    {.address = 0x57, .description = "PCA9685 MB85RC MAX3010x"}, {.address = 0x58, .description = "PCA9685 TPA2016 SGP30"},
    {.address = 0x59, .description = "PCA9685"}, {.address = 0x5a, .description = "MPR121 MLX90614 CCS811 PCA9685 DRV2605"},
    {.address = 0x5b, .description = "PCA9685 CCS811 MPR121"}, {.address = 0x5c, .description = "PCA9685 AM2315 MPR121"},
    ...
    {.address = 0x64, .description = "PCA9685 MCP4725A2 MCP4725A1"}, {.address = 0x65, .description = "PCA9685 MCP4725A2 MCP4725A1"},
    {.address = 0x66, .description = "PCA9685 MCP4725A3 IS31FL3731 MCP4725A1"}, {.address = 0x67, .description = "PCA9685 MCP4725A3 MCP4725A1"},
    ...
    {.address = 0x6a, .description = "PCA9685 L3GD20H PCF8573"}, {.address = 0x6b, .description = "PCA9685 L3GD20H PCF8573"},
    {.address = 0x6c, .description = "PCA9685"}, {.address = 0x6d, .description = "PCA9685"}, {.address = 0x6e, .description = "PCA9685"},
    {.address = 0x6f, .description = "PCA9685 MCP7940N"}, {.address = 0x70, .description = "PCA9685 TCA9548 HT16K33 SHTC3"},
    {.address = 0x71, .description = "PCA9685 TCA9548 HT16K33"}, {.address = 0x72, .description = "PCA9685 TCA9548 HT16K33"},
    {.address = 0x73, .description = "PCA9685 TCA9548 HT16K33"}, {.address = 0x74, .description = "PCA9685 TCA9548 HT16K33"},
    ...
    {.address = 0x78, .description = "PCA9685"}, {.address = 0x79, .description = "PCA9685"}, {.address = 0x7a, .description = "PCA9685"},
    {.address = 0x7b, .description = "PCA9685"}, {.address = 0x7c, .description = "PCA9685"}, {.address = 0x7d, .description = "PCA9685"},
    {.address = 0x7e, .description = "PCA9685"}, {.address = 0x7f, .description = "PCA9685"}, {.address = 0, .description = NULL}};
...
static int do_i2c_set_display(int argc, char** argv) {
    ...
    if(nvs_item && strlen(nvs_item) > 0) { bHasi2cConfig = true; }
    FREE_AND_NULL(nvs_item);

    nvs_item = config_alloc_get(NVS_TYPE_STR, "spi_config");
    if(nvs_item && strlen(nvs_item) > 0) { bHasSpiConfig = true; }
    FREE_AND_NULL(nvs_item);
    ...
    /* Check "--width" option */
    if(i2cdisp_args.width->count) { config.width = i2cdisp_args.width->ival[0]; }
    /* Check "--height" option */
    if(i2cdisp_args.height->count) { config.height = i2cdisp_args.height->ival[0]; }

    /* Check "--driver" option */
    if(i2cdisp_args.driver->count) { config.drivername = display_conf_get_driver_name(i2cdisp_args.driver->sval[0]); }
    if(i2cdisp_args.depth->count > 0 && strcasecmp(config.drivername, "SSD1326") == 0) { config.depth = i2cdisp_args.depth->ival[0]; }
    /* Check "--back" option */
...
static int do_spiconfig_cmd(int argc, char** argv) {
    static spi_bus_config_t spi_config = {.mosi_io_num = -1, .sclk_io_num = -1, .miso_io_num = -1, .quadwp_io_num = -1, .quadhd_io_num = -1};
    int dc = -1, host = 0;
    esp_err_t err = ESP_OK;
...
static int do_i2cdump_cmd(int argc, char** argv) {
    ...
    int size = 1;
    if(i2cdump_args.size->count) { size = i2cdump_args.size->ival[0]; }
    i2c_port_t loc_i2c_port = i2c_port;
    if(i2cset_args.port->count && i2c_get_port(i2cset_args.port->ival[0], &loc_i2c_port) != ESP_OK) { return 1; }
    ...
    for(int i = 0; i < 128; i += 16) {
        ...
        for(int j = 0; j < 16; j += size) {
            ...
            if(size > 1) { i2c_master_read(cmd, data, size - 1, ACK_VAL); }
...
static int do_i2cset_cmd(int argc, char** argv) {
    ...
    int data_addr = 0;
    if(i2cset_args.register_address->count) { data_addr = i2cset_args.register_address->ival[0]; }
    ...
    i2c_master_start(cmd);
    i2c_master_write_byte(cmd, chip_addr << 1 | WRITE_BIT, ACK_CHECK_EN);
    if(i2cset_args.register_address->count) { i2c_master_write_byte(cmd, data_addr, ACK_CHECK_EN); }
    for(int i = 0; i < len; i++) { i2c_master_write_byte(cmd, i2cset_args.data->ival[i], ACK_CHECK_EN); }
    i2c_master_stop(cmd);
...
static int do_i2cget_cmd(int argc, char** argv) {
    ...
    /* Check register address: "-r" option */
    int data_addr = -1;
    if(i2cget_args.register_address->count) { data_addr = i2cget_args.register_address->ival[0]; }
    /* Check data length: "-l" option */
    int len = 1;
    if(i2cget_args.data_length->count) { len = i2cget_args.data_length->ival[0]; }
...
#pragma message("TODO: Fix this!")
    ...
    i2c_master_write_byte(cmd, chip_addr << 1 | READ_BIT, ACK_CHECK_EN);
    if(len > 1) { i2c_master_read(cmd, data, len - 1, ACK_VAL); }
...
static void register_i2c_set_display() {
    ...
    const esp_console_cmd_t i2c_set_display = {
        .command = CFG_TYPE_HW("display"), .help = desc_display, .hint = NULL, .func = &do_i2c_set_display, .argtable = &i2cdisp_args};
...
static void register_i2cdectect(void) {
    ...
    const esp_console_cmd_t i2cdetect_cmd = {
        .command = "i2cdetect", .help = "Scan I2C bus for devices", .hint = NULL, .func = &do_i2cdetect_cmd, .argtable = &i2cdetect_args};
...
static void register_i2cget(void) {
    ...
    const esp_console_cmd_t i2cget_cmd = {
        .command = "i2cget", .help = "Read registers visible through the I2C bus", .hint = NULL, .func = &do_i2cget_cmd, .argtable = &i2cget_args};
...
static void register_i2cset(void) {
    ...
    const esp_console_cmd_t i2cset_cmd = {
        .command = "i2cset", .help = "Set registers visible through the I2C bus", .hint = NULL, .func = &do_i2cset_cmd, .argtable = &i2cset_args};
...
cJSON* i2config_cb() {
    ...
    if(i2c->scl_io_num > 0) { cJSON_AddNumberToObject(values, "scl", i2c->scl_io_num); }
    if(i2c->sda_io_num > 0) { cJSON_AddNumberToObject(values, "sda", i2c->sda_io_num); }
    if(i2c->master.clk_speed > 0) { cJSON_AddNumberToObject(values, "speed", i2c->master.clk_speed); }
    if(platform->dev.i2c.port - sys_i2c_port_PORT0 >= 0) { cJSON_AddNumberToObject(values, "port", platform->dev.i2c.port - sys_i2c_port_PORT0); }
    return values;
}
cJSON* spiconfig_cb() {
    cJSON* values = cJSON_CreateObject();
    const spi_bus_config_t* spi_config = config_spi_get(NULL);
    if(spi_config->mosi_io_num > 0) { cJSON_AddNumberToObject(values, "data", spi_config->mosi_io_num); }
    if(spi_config->sclk_io_num > 0) { cJSON_AddNumberToObject(values, "clk", spi_config->sclk_io_num); }
    if(spi_system_dc_gpio > 0) { cJSON_AddNumberToObject(values, "dc", spi_system_dc_gpio); }
    if(spi_system_host > 0) { cJSON_AddNumberToObject(values, "host", spi_system_host); }
    return values;
}
#if CONFIG_WITH_CONFIG_UI
static void register_spiconfig(void) {
    ...
    const esp_console_cmd_t spiconfig_cmd = {
        .command = CFG_TYPE_HW("spi"), .help = desc_spiconfig, .hint = NULL, .func = &do_spiconfig_cmd, .argtable = &spiconfig_args};
...
static void register_i2cconfig(void) {
    ...
    const esp_console_cmd_t i2cconfig_cmd = {
        .command = CFG_TYPE_HW("i2c"), .help = desc_i2c, .hint = NULL, .func = &do_i2cconfig_cmd, .argtable = &i2cconfig_args};
